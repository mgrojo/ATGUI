...
package TGUI.Rect is
   ...
   tguiFloatRect_Null : aliased constant tguiFloatRect;

   --/< Predefined IntRect with value (0,0,0,0)
   tguiIntRect_Null : aliased constant tguiIntRect;

   --/< Predefined UIntRect with value (0,0,0,0)
   tguiUIntRect_Null : aliased constant tguiUIntRect;

   ----------------------------------------------------------------------------
   function contains (rect : tguiFloatRect; x : tguiFloat; y : tguiFloat) return tguiBool with
     Import => True, Convention => C, External_Name => "tguiFloatRect_contains";

   function contains (rect : tguiIntRect; x : tguiInt; y : tguiInt) return tguiBool with
     Import => True, Convention => C, External_Name => "tguiIntRect_contains";

   function contains (rect : tguiUIntRect; x : tguiUint32; y : tguiUint32) return tguiBool with
     Import => True, Convention => C, External_Name => "tguiUIntRect_contains";

   ----------------------------------------------------------------------------
   function intersects
     (rect : tguiFloatRect; otherRect : tguiFloatRect) return tguiBool with
     Import => True, Convention => C, External_Name => "tguiFloatRect_intersects";

   function intersects (rect : tguiIntRect; otherRect : tguiIntRect) return tguiBool with
     Import => True, Convention => C, External_Name => "tguiIntRect_intersects";

   function intersects
     (rect : tguiUIntRect; otherRect : tguiUIntRect) return tguiBool with
